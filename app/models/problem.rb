...
class Problem < ActiveRecord::Base
  ...
  has_attached_file :photo, :styles => {:s => '60x60#', :m => '300x300#'},
                  :url  => "/uploads/problems/:id/:style/:basename.:extension",
                  :path => ":rails_root/public/uploads/problems/:id/:style/:basename.:extension",
                  :default_url => "/assets/problems/default_:style.png"
