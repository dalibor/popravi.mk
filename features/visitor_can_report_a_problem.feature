...
Scenario: Automatically assigns user to problem when first problem is reported then user registered
  Given I am on the home page
  And category exists
  And municipality exists
  When I follow "Report a problem"
...
Scenario: Automatically assigns user to problem when user registered then problem reported anonymously 
  Given I signed up as "test_user@popravi.mk" with password "secretpass"
  And I confirmed my email address
